...
class BigQueryGcsStorageOperations(
...
) : BigQueryStorageOperations(bigquery, sqlGenerator, destinationHandler, datasetLocation = gcsConfig.bucketRegion!!) {
    ...
    override fun writeToStage(streamId: StreamId, buffer: SerializableBuffer) {
        val stagedFileName: String = uploadRecordsToStage(streamId, buffer)
